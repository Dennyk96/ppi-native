...
<html lang="en-US">
 <head>
   ...
   <title>Sales Report (Customer)</title>
...
<body>
  <?php if($results): ?>
    ...
    <div class="table-wrapper" style="background-color: darkgrey;">
      <h2> Sales Report (Customer) <strong><?php if(isset($start_date)){ echo $start_date;}?> To <?php if(isset($end_date)){echo $end_date;}?> </strong></h2>
    </div>

    <div class="table-wrapper">
    <button type="button" class="btn btn-danger"><a href="pdf_sales_report_customer.php">PDF</a></button>
    </div>
